        ...
        <section id="portfolio" className="py-32 bg-gray-950 border-t border-gray-800">
            <div className="max-w-7xl mx-auto px-5">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Featured App Card */}
                    <div className="card text-left overflow-hidden border-2 border-primary relative group hover:-translate-y-2 shadow-2xl lg:col-span-2">
                        <div className="relative overflow-hidden h-72 md:h-80 bg-gradient-to-br from-gray-800 to-gray-900">
                            <img
                                src={myVirtualCards}
                                alt="MyVirtualCard"
                            ...
                            <div className="absolute top-4 right-4 bg-green-600 text-white px-3 py-1.5 rounded-lg font-bold text-xs shadow-xl flex items-center gap-1.5 animate-pulse">
                                <ion-icon name="sparkles-outline" style={{ fontSize: '14px' }}></ion-icon>
                                LIVE NOW
                            </div>
                        </div>
                        <div className="p-6 md:p-7">
                            <h3
                                onClick={openModal}
                                className="text-2xl md:text-3xl font-bold text-white mb-2 group-hover:text-primary transition-colors font-poppins cursor-pointer hover:underline"
                            >
                                MyVirtualCards
                            </h3>
                            ...
                            <div className="flex flex-wrap gap-3 items-center">
                                <span className="inline-block bg-primary/10 text-primary font-semibold text-xs md:text-sm px-4 py-2 rounded-lg border border-primary/30">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-white font-semibold text-sm px-5 py-2 rounded-lg transition-colors shadow-lg hover:shadow-xl"
                                >
                                    Get on Google Play
                                </a>
                            </div>
                    ...
                    <div className="card overflow-hidden relative group hover:-translate-y-2 shadow-2xl bg-gray-800 flex flex-col items-center justify-center p-6 md:p-7 text-center">
                        <div className="w-16 h-16 mb-3 rounded-2xl bg-primary/15 border border-primary/30 flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300">
                            <ion-icon name="rocket-outline" style={{ fontSize: '30px', color: 'var(--color-primary)' }}></ion-icon>
                        </div>
                        <h3 className="text-base md:text-lg font-bold text-gray-300 mb-1.5">More Projects Coming</h3>
                        <p className="text-xs md:text-sm text-gray-500">Check back soon for upcoming launches</p>
                    </div>
                </div>
